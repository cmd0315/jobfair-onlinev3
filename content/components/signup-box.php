...
<!-- START SIGNUP FORM-->
	...
	<!--<div class="row-fluid">
		<div class="span8 offset4" >
			<h6><a id="resendVCodeLink" style="cursor:pointer; text-decoration:underline; color:white; padding-left:46px;" onclick="resendVCode();">Re-send verification code</a></h6>
		</div>
	</div>-->
	<input type="hidden" id="status" name="status" value="Employee"/>
