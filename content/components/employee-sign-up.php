						...
						<div class="basic-info-form1">
							<div class="control-group">
								...
								<div class="controls controls-row">
								  <input type="text" class="span4" id="firstName" name="firstName" pattern="[a-zA-Z _]{2,}" minlength="2" value="<?php echo $user_profile['first_name']; ?>" placeholder="FIRST NAME" required />
								   <input type="text" class="span4" id="middleName" name="middleName" pattern="[a-zA-Z _]{2,}" minlength="2" value="<?php echo $user_profile['middle_name']; ?>" placeholder="MIDDLE NAME" required />
								   <input type="text" class="span4" id="lastName" name="lastName" pattern="[a-zA-Z _]{2,}" minlength="2" value="<?php echo $user_profile['last_name']; ?>"  placeholder="LAST NAME" required />
							 ...
							 <div class="row-fluid">
								...
								<div class="span6">
									 <div class="control-group">
										...
										<div class="controls">
											<input class="span12" type="text" id="birthPlace" name="birthPlace" minlength="5" value="<?php echo $user_profile['hometown']['name']; ?>" placeholder="BIRTH PLACE" required />
											<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
										</div>
									 </div>
								</div>
							...
							<div class="row-fluid">
								<div class="span7">
									  <div class="control-group">
										...
										<div class="controls controls-row">
											...
											<input class="span6" type="number" id="heightIn" name="heightIn" min="0" max="59" placeholder="in.">
											<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
										</div>
									 </div>
								</div>
								<div class="span5">
									 <div class="control-group">
										<label class="control-label">WEIGHT<br><span id="formLabel" style="font-weight:normal; color:#404040;">( lbs. )</span></label>
										<div class="controls">
							...
							<div class="row-fluid">
								<div class="control-group">
									...
									<div class="controls">
										<input type="email" class="span12" id="email" name="email" style="margin-right:80px;" value="<?php echo $user_profile['email'];?>" placeholder="EMAIL ADDRESS" <?php echo $emailDisabled;?>> 
										<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
									</div>
								</div>
							</div>
								 ...
								 <div class="row-fluid form-horizontal">
									...
									<div class="span5">
										  <div class="control-group">
											...
											<div class="controls">
												<input class="span12" type="number" min=<?php echo $minYear;?> max=<?php echo $maxYear;?> id="hsEndYr" name="hsEndYr" placeholder="YYYY"/>
												<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
											</div>
										 </div>
									</div>
								...
								<div class="row-fluid form-horizontal">
									...
									<div class="span5">
										  <div class="control-group">
											<label class="control-label" id="formLabel">(YEAR GRADUATED)</label>
											<div class="controls">
												<input class="span12" type="number" min=<?php echo $minYear;?> max=<?php echo $maxYear;?> id="collegeEndYr" name="collegeEndYr" placeholder="YYYY"/>
												<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
											</div>
										 </div>
									</div>
								...
								<div class="row-fluid form-horizontal">
									...
									<div class="span5">
										  <div class="control-group">
											<label class="control-label" id="formLabel">(YEAR GRADUATED)</label>
											<div class="controls">
												<input class="span12" type="number" min=<?php echo $minYear;?> max=<?php echo $maxYear;?> id="vocationalEndYr" name="vocationalEndYr" placeholder="YYYY"/>
													<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
											</div>
										 </div>
									</div>
							...
							<div class="control-group">
								<div class="controls">
								  <label class="checkbox"  id="terms">
									<input type="checkbox" data-validation-callback-callback="callback_ta" required> I agree to<a  href="#termsModal" role="button" data-toggle="modal"> People-Link.Asia, Inc. Terms</a>.
								  </label>
								</div>
							</div>
						</div>
			...
			<div class="span12">
				<div class="row-fluid">
					<div class="span7 offset1">
						<p class="text-info" style="font-weight:bold;">The information in this profile will be sent to People-Link.Asia, Inc.'s employee database. </p>
					</div>
					<div class="span3">
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" aria-hidden="true">
  ...
  <div class="modal-body">
	<div class="row-fluid">
		<div class="span12">
			  <p style="text-align: center;">Thank you for joining People-Link.Asia, Inc.!<br/>Your username is <span class="text-info" style="font-weight:bold;"><?php echo $username;?></span>. To finish the registration, you must verify your account.</p>
		</div>
	</div>
  </div>
...
<div id="fbModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" aria-hidden="true">
  ...
  <div class="modal-body">
	<div class="row-fluid">
		<div class="span12">
			  <p style="text-align: center;">Thank you for joining People-Link.Asia, Inc.!<br/>Your profile has been created. <br>Username: <span class="text-info" style="font-weight:bold;"><?php echo $username;?></span></p>
		</div>
	</div>
  </div>
  <div class="modal-footer">
...
$("#extraInterest").select2({
	...
	$('#signup-form').submit(function() { 
		...
		if(heightIn<0 || heightIn > 9){
			errorMsg += "<li>Inputted <strong>height in in.</strong> should not be lesser than 0 in. or greater than 9 in.</li>";
			errors +=1;
		}
		
		if(weight<60 || weight> 300){
			errorMsg += "<li>Inputted <strong>weight in lbs.</strong> should not be lesser than 60 lbs. or greater than 9 lbs.</li>";
			errors +=1;
		}
		
		if(bDateYear<minYear || bDateYear>maxYear){
			errorMsg += "<li>Inputted <strong>age</strong> should be between 18-60 years old. (See birth date)</li>";
			errors +=1;
		}
