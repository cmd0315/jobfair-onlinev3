...
<div class="wrap">
	...
	<!-- END HEADER -->
	<!-- START SEARCH NAVBAR  -->
	<?php echo $navbar=getEmployerNavBar(); ?>
	<!-- END SEARCH NAVBAR  -->
							...
							<div class="span6">
								<div class="row-fluid">
									<div class="control-group">
										...
										<div class="controls">
											  <select class="span12" id="cpPosition" name="cpPosition" required>
													<?php
														foreach($cpPositions as $cpPs) {
															if($cpPs == $cpPosition){
																echo "<option value=\"$cpPs\" selected=\"selected\">$cpPs</option>";
															}
															else{
							...
							<div class="span6">
								<div class="row-fluid">
									<div class="control-group">
										...
										<div class="controls">
										 <select class="span12" id="cpDept" name="cpDept" required>
													<?php
														foreach($cpDepts as $cpDs) {
															if($cpDs == $cpDept){
																echo "<option value=\"$cpDs\" selected=\"selected\">$cpDs</option>";
															}
															else{
