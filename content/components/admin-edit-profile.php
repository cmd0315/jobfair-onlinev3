...
<div class="wrap">
	...
	<!-- END HEADER -->
		<!-- START SEARCH NAVBAR  -->
	<?php echo $searchBar=getSearchBar(); ?>
	<!-- END SEARCH NAVBAR  -->
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="row-fluid">
					...
					<div class="span5">
						<button type="button" class="btn btn-primary span6" id="changeAcctInfo" name="changeAcctInfo" onclick="changeAccountInfo();">CHANGE ACCOUNT DETAILS</button>
