				...
				<div class="row-fluid">
					<div class="span12 well">
						...
						<ul id="map" class="nav nav-tabs nav-stacked" align="center">
							...
							<li id="reports" name="reports"><a href="admin-reports.php" rel="tooltip" data-placement="bottom" title="View registrations, job posts and job applications" data-trigger="hover"><i class="icon-book"></i> ADMIN REPORTS</a></li>
							<li id="search" name="search"><a href="admin-search-employees.php" rel="tooltip" data-placement="bottom" title="Filter employee and employers based on job positions"><i class="icon-globe"></i> QUALIFIED USERS</a></li>
							<li id="jobpos" name="jobpos"><a href="edit-job-positions.php" rel="tooltip" data-placement="bottom" title="Manage Job Positions"><i class="icon-briefcase"></i> JOB POSITIONS</a></li>
							<li id="supportemail" name="supportemail"><a href="https://email22.secureserver.net/webmail.php" rel="tooltip" data-placement="bottom" title="Check emails in account: support@people-link.asia"><i class="icon-envelope"></i> SUPPORT EMAIL</a></li>
						</ul>
					</div>
				</div>
				<div class="row-fluid">
