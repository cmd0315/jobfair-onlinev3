	...
	<div class="container-fluid">
							...
							<div class="row-fluid">
								<div class="span7">
									  <div class="control-group">
										...
										<div class="controls controls-row">
											...
											<input class="span6" type="number" id="heightIn" name="heightIn" value="<?php echo $heightIn;?>" min="0" max="59">
											<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
										</div>
									 </div>
								</div>
								<div class="span5">
									 <div class="control-group">
										...
										<div class="controls">
											<input class="span12" type="number" id="weight" name="weight" value="<?php echo $weight; ?>" min="60" max="300">
											<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
										</div>
									</div>
								</div>
							...
							<div class="row-fluid form-horizontal">
									...
									<div class="span5">
										  <div class="control-group">
											...
											<div class="controls">
												<input class="span12" type="number" min=<?php echo $minYear;?> max=<?php echo $year;?> id="hsEndYr" name="hsEndYr" placeholder="YYYY" value="<?php echo $hsEndYr; ?>" />
												<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
											</div>
										 </div>
									</div>
								...
								<div class="row-fluid form-horizontal">
									...
									<div class="span5">
										  <div class="control-group">
											<label class="control-label" id="formLabel">(YEAR GRADUATED)</label>
											<div class="controls">
												<input class="span12" type="number" min=<?php echo $minYear;?> max=<?php echo $year;?> id="collegeEndYr" name="collegeEndYr" placeholder="YYYY" value="<?php echo $collegeEndYr; ?>" />
												<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
											</div>
										 </div>
									</div>
								...
								<div class="row-fluid form-horizontal">
									...
									<div class="span5">
										  <div class="control-group">
											<label class="control-label" id="formLabel">(YEAR GRADUATED)</label>
											<div class="controls">
												<input class="span12" type="number" min=<?php echo $minYear;?> max=<?php echo $year;?>  id="vocationalEndYr" name="vocationalEndYr" placeholder="YYYY" value="<?php echo $vocEndYr; ?>" />
												<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
											</div>
										 </div>
									</div>
						...
						<div class="row-fluid">
							...
							<?php
								for ($i=0; $i<$workHistoryCount; $i++){
									...
									$positionID = getWHRowData($username, $rNum, "position-id");
		...
		<div class="row-fluid">
			<div class="span6 offset5">
				<button type="button" class="btn btn-primary span7" id="changeAcctInfo" name="changeAcctInfo" onclick="changeAccountInfo();">CHANGE ACCOUNT INFORMATION</button>
				<button type="submit" class="btn btn-primary job-post-add span5" id="submitApply" name="submitApply">SAVE CHANGES</button>				
				</form>
				<!--END SIGNUP FORM-->
			</div>
		</div>
...
$(document).ready(function() { 
	...
	$('#edit-form').submit(function() { 
		...
		if(bDateYear<minYear || bDateYear>maxYear){
			errorMsg += "<li>Inputted <strong>age</strong> should  be between 18-60 years old.</li>";
			errors +=1;
		}
...
function removeThisField(inptBtn, rowNum) {
	var currReqFieldName = "add" + inptBtn;
	var hr = new XMLHttpRequest();
	var url = "delete-row.php?rownum="+rowNum;
