							...
							<div class="span6">
								<div class="row-fluid">
									<div class="control-group">
										...
										<div class="controls">
											  <select class="span12" id="cpPosition" name="cpPosition"  data-placeholder="Choose job position" required>
													<option></option>
													<?php
														foreach($cpPositions as $cpPs) {
															echo "<option value=\"$cpPs\">$cpPs</option>";
														}
													?>
												</select>
											<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
							...
							<div class="span6">
								<div class="row-fluid">
									<div class="control-group">
										...
										<div class="controls">
											<select class="span12" id="cpDept" name="cpDept"  data-placeholder="Choose job department" required>
													<option></option>
													<?php
														foreach($cpDepts as $cpDs) {
															echo "<option value=\"$cpDs\">$cpDs</option>";
														}
													?>
												</select>
												<p class="help-block" style="font-size:11.5px; background-color:lightgrey;"></p>
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"  aria-hidden="true">
  ...
  <div class="modal-body">
	<div class="row-fluid">
		<div class="span12">
			   <p style="text-align: center;">Thank you for joining People-Link.Asia, Inc.! <br/>Your username is <span class="text-info" style="font-weight:bold;"><?php echo $username;?></span>. To finish the registration, verify your account by entering the confirmation code sent to this mobile number. </p>
		</div>
	</div>
  </div>
