...
<div class="wrap">
	<!-- START HEADER  -->
	<div class="row-fluid" id="site-title-box" name="site-title-box">
				...
				<div class="span12" style="margin-left:2.547009%">
					<div class="row-fluid">
						<div class="span5">
							<div class="row-fluid">
								<div class="span12">
									<img src="./img/logo3.png" style="cursor:pointer;" onclick="window.location.href='./index.php';"/>
								</div>
							</div>
						</div>
						<div class="span4 offset3" style="padding-right:55px;">
							<div class="row-fluid">
								<p style="text-align:right;">Applicant's <strong><a href="index.php" style="text-decoration:underline;">Page</a></strong> here</p>
							</div>
							<div class="row-fluid">
								<p style="text-align:right;"><span class="lang">English <span class="divider">|</span><a href="#"> Tagalog</a></span></p>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="row-fluid">
		<div class="span10 offset1" style="background-color:white;">
			<div class="row-fluid">
				<div class="span8 offset2" id="slider-container">
					<div id="myCarousel" class="carousel slide">
						<ol class="carousel-indicators">
							<li class="span12" data-target="#myCarousel" data-slide-to="0" class="active"></li>
							<li class="span12" data-target="#myCarousel" data-slide-to="1"></li>
						</ol>
					  <!-- Carousel items -->
								...
								<div class="span12">
									<div class="row-fluid">
										<div class="span3 offset1">
											<center><img src="img/carousel/te1pic.png" id="sliderImg1" name="sliderImg2" alt="slider-img1"></center>
										</div>
										<!-- START SLIDER CAPTION -->
										<div class="span7">
											<div class="row-fluid" style="height:23px;"></div>
											<div class="row-fluid">
												<p id="employer_testimonial">Employer Testimonials</p>
												<center><p class="slider-caption">"<span class="quote-caption" >It was so easy to post a job through people-link.asia! Thank you very much!</span>"<cite title="Applicant" style="font-weight:normal"><small>- Bruno Mart</small> </cite></p></center>
											</div>
										</div>
									<!-- END SLIDER CAPTION -->
									</div>
						...
						<div class="item">
							<div class="row-fluid">
								<div class="span12">
									<div class="row-fluid">
										<div class="span3 offset1">
											<center><img src="img/carousel/t1pic.png" id="sliderImg2" name="sliderImg2" alt="slider-img2"></center>
										</div>
										<!-- START SLIDER CAPTION -->
										<div class="span7">
											<div class="row-fluid" style="height:23px;"></div>
											<div class="row-fluid">
												<p id="employer_testimonial">Employer Testimonials</p>
												<center><p class="slider-caption">"<span class="quote-caption" >People-link.asia helped me find the right employees for my company. Thank you for the great service!</span>"<cite title="Applicant" style="font-weight:normal"><small>- Ystacey Ty</small> </cite></p></center>
											</div>
										</div>
									<!-- END SLIDER CAPTION -->
									</div>
					...
					<div class="span12 well">
						...
						<div class="row-fluid">
							<div class="span10">
								...
								<p>Welcome to People-Link.Asia! You’re ready to post your first job listing. Just fill out the required fields below and click “Post Job” to add your first listing. </p>
							</div>
						</div>
						<div class="row-fluid">
							<div class="span12">
