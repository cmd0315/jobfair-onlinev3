							...
							<div class="span12 well">
								<div class="tabbable tabs-left">
									<ul class="nav nav-tabs nav-pills">
										...
										<li><button class="btn btn-info span12 employerDashboardBtn" id="editBtn" name="editBtn" onclick="edit();">EDIT JOB POST</button></li>
												...
												<table class="display table-striped table-hover table-condensed" width="100%"  id="record_table" style="text-align:center;">
													...
													<?php
														while($jobPostsData = mysql_fetch_assoc($getJobPosts)){
															...
															<td><button type=\"button\" class=\"btn-primary btn-mini\" id=\"addBtn\" style=\"margin-top:-5px; border-radius: 25px; width: 26px; height: 26px; box-shadow: 2px 2px 5px #888888;\" ><a href=\"search-employees.php?code=$jobPostCode\"><i id=\"icon\" class=\"icon-search icon-white\" style=\"margin-left:-2px; padding-top:1px;\"></i></a></button></td>
															</tr>";
