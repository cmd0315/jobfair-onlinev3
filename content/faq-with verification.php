				...
				<div class="row-fluid">
					<div class="span12"> 
						<dl>
							...
							<dd>
								<ol>
									<li>Log in to your Facebook account using the link found of the People-link.asia homepage.</li>
									...
									<li>You should now be able to log in using your People-link.asia account!</li>
								</ol>
							</dd><br/>
							...
							<dt><i class="icon-question-sign"></i> How do I resend the verification code? I wasn’t able to receive a text or email.</dt>
							<dd>
								<ol>
									<li>Click the “Sign Up” menu on the homepage. There will be a dropdown menu on the sign up link, where you can choose the “Resend verification code” option.</li>
									...
									<li>In the box provided, enter the verification code.</li>
									<li>Click “Verify Account.”</li>
									<li>You will be redirected to the “Log In” page, where you can access the site using your People-link.asia account.</li>
								</ol>
							</dd>
