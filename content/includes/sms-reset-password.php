...
$status = $gsm_send_sms->send("$number", "This is an automated SMS from People-Link.Asia, Inc., do NOT reply. Your password verification code is: $verification."); 
if ($status) { 
    echo "Message sent\n"; 
} else { 
...
/*$status = $gsm_send_sms->send('+639178850063', 'This is an automated SMS from people-link, Your verification is 1234'); 
if ($status) { 
    echo "Message sent\n"; 
} else { 
    echo "Message not sent\n"; 
