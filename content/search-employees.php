...
//add log activity
$addLogQuery = "INSERT INTO activity_logs(date_made, username, action, reference_object) VALUES('$currDateTime', '$username', 'SEARCH QUALIFIED JOB POST APPLICANTS', '$jobPostCode')";
	...
	<div class="container-fluid">
		<div class="row-fluid" id="content">
			<div class="span10 offset1">
				<h5 id="e-dash-tag" style="text-decoration:none;">Here's a list of qualified applicants for <span style="color:black;"><?php echo $jobPosition; ?></span> position.</h5>
			</div>
		</div>
		<div class="row-fluid">
...
var resultsFileURL = "reports-employer-search-applicants.php?jobPostCode="+jobPostCode+"&type=qualified";
...
function showTable(){
	...
	var url = "reports-employer-search-applicants.php?jobPostCode="+jobPostCode+"&type=qualified";
	var linkVariables = "";
