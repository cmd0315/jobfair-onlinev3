	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span5 offset4">
				<button type="button" class="btn btn-primary span8" id="resendVCode" name="resendVCode" onclick="reVerify();">RESEND VERIFICATION CODE</button>
				<button type="submit" class="btn btn-primary span4" id="signup-btn" name="submit"/>CONFIRM</button>
			</div>
		</form>
		<!-- END FORM -->
		</div>
