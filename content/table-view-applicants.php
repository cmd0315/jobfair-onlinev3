...
$applicantsQuery =  "SELECT employee_username FROM application_history WHERE job_code='$jobPostCode' ORDER BY date_applied DESC";
...
while($applicantData = mysql_fetch_assoc($getApplicants)){
	$username = $applicantData['employee_username'];
