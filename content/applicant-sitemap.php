				...
				<div class="row-fluid">
					<div class="span12 well">
						...
						<ul id="map" class="nav nav-tabs nav-stacked" align="center" style="text-align: center;">
							...
							<li id="resume" name="resume"><a href="#" rel="tooltip" data-placement="bottom" title="View PDF copy of resume" onclick="viewResumeEmp('<?php echo $username;?>');"><i class="icon-file"></i> VIEW RESUME</a></li>
