					...
					<div class="span12 well">
						...
						<div class="tabbable">
							<ul class="nav nav-tabs nav-pills">
								<li class="active"><a href="#lE" data-toggle="tab">Search Applicants</a></li>
								<li><a href="admin-search-employers.php">Search Employers</a></li>
							</ul>
...
$(document).ready(function(){
	...
	var $elem = $('#content');
	//$('html, body').animate({scrollTop: $elem.height()/4}, 1000);
	changePagination('0'); //start displaying results starting from first page
});

var resultsFileURL = "reports-admin-search-applicants.php";
...
function showTable(){
	...
	var url = "reports-admin-search-applicants.php";
	var linkVariables = "";
...
function exportApplicantData(){
	...
	if(applicantUsername !== ""){
		...
		$.ajax({
		   ...
		   success: function(result){
		   	$(".flash").hide();
		      window.location.href = "applicant-contact-sheet.php?usernames="+applicantUsername+"&jobPositions="+jobPositions;
		   }
		});
