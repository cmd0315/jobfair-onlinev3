...
$updateJobPostQuery = "UPDATE job_post SET status2='1' WHERE code='$jobPostCode' ";
...
//add log activity
$addLogQuery = "INSERT INTO activity_logs(date_made, username, action, reference_object) VALUES('$currDateTime', '$sessionUsername', 'REMOVE JOB POST', '$jobPostCode')";
